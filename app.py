...
with tab_home:
    ...
    r1 = st.columns(3)
    r1[0].metric("D1 TOR", fmt(nums["d1_tor"]))
    r1[1].metric("D1 WIND", fmt(nums["d1_wind"]))
    r1[2].metric("D1 HAIL", fmt(nums["d1_hail"]))

    r2 = st.columns(3)
    r2[0].metric("D2 TOR", fmt(nums["d2_tor"]))
    r2[1].metric("D2 WIND", fmt(nums["d2_wind"]))
    r2[2].metric("D2 HAIL", fmt(nums["d2_hail"]))

    r3 = st.columns(4)
    r3[0].metric("D4", fmt(nums["d4_prob"]))
    r3[1].metric("D5", fmt(nums["d5_prob"]))
    r3[2].metric("D6", fmt(nums["d6_prob"]))
    r3[3].metric("D7", fmt(nums["d7_prob"]))
